...
const FeaturesMenu = () => {
  return (
    <>
      <div className={"space-y-2 rounded-2xl py-5 pl-11 text-[14px] font-medium text-medium-gray drop-shadow-2xl lg:absolute lg:left-[-1.9rem] lg:top-[2rem] lg:bg-white lg:px-5"}>
